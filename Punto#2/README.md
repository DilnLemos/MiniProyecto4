Este repositorio fue hecho con el fin de publicar el ultimo mini proyecto de la asignatura "Fundamentos de Programación Orientada Eventos" de Tercer Semestre, de la Universidad del Valle sede Tuluá.
